/* Auto-generated by genmsg_cpp for file /home/hakan/ros_workspace/jaguarControlISL/gps_node/msg/GPSStatus.msg */
#ifndef GPS_NODE_MESSAGE_GPSSTATUS_H
#define GPS_NODE_MESSAGE_GPSSTATUS_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct GPSStatus_ {
  ...
  typedef boost::shared_ptr< ::gps_node::GPSStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::gps_node::GPSStatus_<ContainerAllocator>  const> ConstPtr;
  boost::shared_ptr<std::map<std::string, std::string> > __connection_header;
}; // struct GPSStatus
typedef  ::gps_node::GPSStatus_<std::allocator<void> > GPSStatus;

typedef boost::shared_ptr< ::gps_node::GPSStatus> GPSStatusPtr;
typedef boost::shared_ptr< ::gps_node::GPSStatus const> GPSStatusConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::gps_node::GPSStatus_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::gps_node::GPSStatus_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::gps_node::GPSStatus_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::gps_node::GPSStatus_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::gps_node::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
    return "313baa8951fdd056c78bf61b1b07d249";
  }

  static const char* value(const  ::gps_node::GPSStatus_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x313baa8951fdd056ULL;
  static const uint64_t static_value2 = 0xc78bf61b1b07d249ULL;
};

template<class ContainerAllocator>
struct DataType< ::gps_node::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
    return "gps_node/GPSStatus";
  }
...
template<class ContainerAllocator>
struct Definition< ::gps_node::GPSStatus_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct HasHeader< ::gps_node::GPSStatus_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::gps_node::GPSStatus_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
...
template<class ContainerAllocator> struct Serializer< ::gps_node::GPSStatus_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::gps_node::GPSStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::gps_node::GPSStatus_<ContainerAllocator> & v) 
  {
    s << indent << "header: ";
s << std::endl;
...
#endif // GPS_NODE_MESSAGE_GPSSTATUS_H
